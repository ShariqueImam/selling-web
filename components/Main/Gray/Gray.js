...
const Gray = () => {
  return (
    <div className="w-[100%] md:w-[85%] lg:w-[65%] mx-auto my-12 md:py-24 px-4 md:px-0">
      <p
        className="text-[#535353] bg-[#f0f0f0] px-4 md:px-6 py-3 md:py-9 text-center text-xs md:text-sm tracking-wide"
        style={{ lineHeight: "37px" }}
      >
        <Link href="">
          <span className="underline">nachsendeauftrag-einrichten.de</span>
        </Link>
