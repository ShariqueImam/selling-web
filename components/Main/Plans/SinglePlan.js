    ...
    <div className="w-[100%] nav md:mx-5 plan-shadow my-5 md:my-1">
      ...
      <div className="flex">
        <div className="flex flex-col items-center justify-center w-[100%] py-4 md:py-6">
          ...
          <p className="text-[#535353] text-center text-xs md:text-md my-1">unter than {p11}, -€ im Monat</p>
        </div>
        <div className="flex flex-col items-center justify-center w-[100%] py-4 md:py-6">
          <p className="text-[#535353] text-center">EUR {p2}</p>
          <p className="text-[#535353] text-center text-xs md:text-md my-1">unter than {p12}, -€ im Monat</p>
        </div>
      </div>
    </div>
  );
