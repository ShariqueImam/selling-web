...
const style = {
  wrapper:
    "flex flex-col items-center justify-center w-[100%] md:w-[65%] mx-auto ",
};
const Home = () => {
  return (
    <div className={style.wrapper}>
      <div className="text-[#535353] flex flex-row items-center justify-around bg-[#f0f0f0] w-[100vw] pb-16 aa transform ">
      ...
      {/* adding the image */}
      <div className="flex  md:top-[12rem] lg:top-[11rem] items-start flex-col  md:flex-row ">
        <div className="hidden sm:flex">
          <Image src="/assets/postbox.png" width={330} height={200} />
        </div>
        <HomeCard />
        <HomeCardPhone />
      </div>
