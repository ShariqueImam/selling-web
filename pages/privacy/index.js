...
const index = () => {
  return (
    <div className="text-[#535353] font-light w-[95%] md:w-[85%] lg:w-[65%] mx-auto my-8 md:my-12 ">
      ...
      <p className={style.para}>Scalable Services GmbH</p>
      <p className={style.para}>Carl-Reuther-Str. 1</p>
      <p className={style.para}>68305 Mannheim</p>
      <p className={style.para}>Deutschland</p>
      <p className={style.para}>Tel.: 01805-99 77 40</p>
      <p className={style.para}>Webseite: www.nachsendeauftrag-einrichten.de</p>
      <p className={style.para}>
      ...
      <p className={style.para}>
        ...
        Einwilligung des Nutzers (auch „betroffene Person genannt“) einholen,
        dient Art. 6 Abs. 1 lit. a DSGVO als Rechtsgrundlage. Bei der
      ...
      <p className={style.para}>
        ...
        Speicherung nicht mehr erforderlich ist, also der Zweck der Speicherung
        entfallen ist, oder schränken die Verarbeitung ein, falls gesetzliche
      ...
      <li className={style.para}>Recht auf Auskunft</li>
      <li className={style.para}>
        Recht auf Berichtigung und/oder Vervollständigung oder Löschung
      </li>
      <li className={style.para}>Recht auf Einschränkung der Verarbeitung</li>
      <li className={style.para}>Recht auf Löschung</li>
      <li className={style.para}>Recht auf Unterrichtung</li>
      <li className={style.para}>Recht auf Datenübertragbarkeit</li>
      <p className={style.para}>
      ...
      <p className={style.para}>
        ...
        wenden Sie sich bitte ebenfalls an uns unter den oben angegebenen
        Kontaktdaten.
      </p>
      <p className={style.heading}>
      ...
      <p className={style.para}>
        ...
        Wenn Sie unsere Webseite betrachten möchten, erheben wir die folgenden
        Daten, die für uns technisch erforderlich sind, um Ihnen unsere Webseite
      ...
      <p className={style.para}>
        ...
        Daten des Nutzers findet nicht statt (Rechtsgrundlage ist Art. 6 Abs. 1
        lit. f DSGVO).
      </p>
      <p className={style.para}>
      ...
      <p className={style.para}>
        ...
        möglich ist. Die Erfassung der Daten zur Bereitstellung der Webseite und
      ...
      <p className={style.para}>
        ...
        Textdateien, die auf Ihrer Festplatte den von Ihnen verwendeten Browser
        ...
        Programme ausführen oder Viren auf Ihren Computer übertragen. Sie helfen
        das Internetangebot insgesamt nutzerfreundlicher und effektiver zu
        machen. Die Rechtsgrundlage für die Verarbeitung personenbezogener Daten
        unter Verwendung von Cookies ist Art. 6 Abs. 1 lit. f DSGVO.
      </p>
      <p className={style.para}>
        Unsere Webseiten setzen temporäre und permanente Cookies ein. Temporäre
        Cookies werden automatisiert gelöscht, wenn Sie den Browser schließen.
        Dazu zählen insbesondere die sogenannten Session-Cookies. Diese
        ...
        kann ihr Rechner wiedererkannt werden, wenn Sie auf unserer Webseite
        zurückkehren. Die Session-Cookies werden gelöscht, wenn Sie sich
        ausloggen oder den Browser schließen. Permanente Cookies hingegen werden
      ...
      <p className={style.para}>
        ...
        jederzeit gelöscht werden. Dies kann auch automatisiert erfolgen. Bitte
        beachten Sie dabei, dass einzelne Funktionen unserer Webseite
      ...
      <p className={style.para}>
        Falls Sie eine Einwilligung (Art.6 Abs.1 lit. a DSGVO) zur Verarbeitung
      ...
      <p className={style.para}>
        ...
        verarbeiten sollten. Im Fall Ihres begründeten Widerspruchs prüfen wir
        ...
        aufgrund derer wir die Verarbeitung fortführen werden.
      </p>
      <p className={style.heading}>7. Verarbeitung personenbezogener Daten</p>
      <p className={style.para}>
        Die Daten werden für die Vertragserfüllung auf Grundlage des Art. 6 Abs.
        1 lit. b DSGVO verarbeitet. Zur Abwicklung Ihres Auftrags arbeiten wir
        teilweise auch mit Dienstleistern zusammen, die uns ganz oder teilweise
        bei der Durchführung der geschlossenen Verträge unterstützen.
      </p>
      <p className={style.para}>
        Enso erfolgt eine Weitergabe im Rahmen von gesetzlichen Verpflichtungen
        (z.B. an Ermittlungsbehörden). Weiterhin sind Leistungen zum
        Kundenservice oder auch bzgl. der IT an Dienstleister ausgelagert An
        diese Dienstleister werden die erhobenen Daten auf Grundlage des Art. 6
        Abs. 1 lit. b DSGVO weitergegeben.
      </p>
      <p className={style.para}>
        Eine Verarbeitung Ihrer Daten in einem Drittstaat erfolgt grundsätzlich
        nicht. Sofern Ihre neue Anschrift jedoch im Ausland liegt, erfolgt eine
        Übergabe der Daten an den dortigen Postdienstleister zwecks
        Vertragserfüllung. oder Ihre Daten werden auch in einem sog. Drittstatt
        verarbeitet. Dies erfolgt entweder, da die Übermittlung zur
        Vertragserfüllung erforderlich ist, auf Basis der
